...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'v1/result.data';
      var REMOTE_PACKAGE_BASE = 'result.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_v1/result.data');

      };
      Module['addRunDependency']('datafile_v1/result.data');
    ...
    loadPackage({"files": [{"filename": "/tiles.png", "start": 0, "end": 245}], "remote_package_size": 245});
